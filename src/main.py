...
def plot_fixations(merged_intervals):
    # Extract the 'position' column as a list of lists
    positionsL = merged_intervals[merged_intervals['type'] == 'fixation']['positionLeft'].tolist()

    positionsR = merged_intervals[merged_intervals['type'] == 'fixation']['positionRight'].tolist()
    ...
    # Create a list of saccade durations
    durations = merged_intervals[merged_intervals['type'] == 'fixation']['duration'].tolist()
    ...
    ax.set_xlabel('X coordinate on display')
    ax.set_ylabel('Y coordinate on display')
    ax.set_title('fixation Duration Heatmap')
    ...
    ax.set_xlabel('X coordinate on display')
    ax.set_ylabel('Y coordinate on display')
    ax.set_title('fixation Locations Heatmap')
